...
public class ContainsSenderMailFilter extends Filter {
    ...
    public ContainsSenderMailFilter(DateiVerwaltung dateiVerwaltung, String filterCriteria) {
    ...
    public List getMessages() {
        ...
        while(it.hasNext()){
            ...
            if(m.getSender().getMailAddress().contains(filterCriteria))messageList.add(m);
        }
